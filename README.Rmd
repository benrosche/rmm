...
- The MMMM can be used to model spatial structures. Level-1 units, in this case, would be the neighborhoods in the 
...
- The MMMM can be used to model network structures. While this possibility has been explored in other work (Tranmer et al. 2014),
